...
//	        aStorage.add("c");
	   ...
	   public static void exampleOfHowToUseIt( MyLinkedList<String> aStorage)   {
	        ...
	        bStorage.add(0,"f");
	        bStorage.add(0,"h");
	        if ( ! bStorage.addAll(bStorage) )
	                System.out.println("You can not add yourself to yourself.");
	        bStorage.addLast("a");
	        if ( ! bStorage.addLast("a") )
	        	System.out.println("You can not add same element to yourself.");
	        for(int i=0;i<bStorage.size();i++) { 
        	System.out.println("BStorage: " +bStorage.get(i) );
	        }
	        System.out.println();
	        aStorage.addAll(bStorage);
	        for(int i=0;i<aStorage.size();i++) { 
	        	System.out.println("AStorage: " +aStorage.get(i) );
	        }
